...
(function (Aufgabe06) {
    //Artikeln erstelen
    let pen = { name: "Faber Castell PITT Artist Pen", photo: "images/markers5.jpg", beschreibung: "Set of 8,black", price: 15, category: "inking" };
    let artistpen = { name: "Faber Castell PITT Artist Pen", photo: "images/markers6.jfif", beschreibung: "Shades of Grey, Set of 6 soft brush markers", price: 12.50, category: "inking" };
    let inkpen = { name: "Ink Pen", photo: "images/ink8.jpg", beschreibung: "Set of 4 different sizes", price: 15, category: "inking" };
    let ink = { name: "Drawing Ink", photo: "images/ink9.jpg", beschreibung: "SDifferent Colours available,78ml", price: 4, category: "inking" };
    let artikelnInking = [pen, artistpen, inkpen, ink]; //Array
    let watercolors = { name: "Koi Watercolour Paints", photo: "images/koiwater14.jpg", beschreibung: "Travel Set-12 Colours", price: 15, category: "painting" };
    let paints = { name: "Watercolour Paints", photo: "images/paints11.jpg", beschreibung: "Box set of 36 Coours x 59ml", price: 30, category: "painting" };
    let pencils = { name: "Derwent Watercolour Pencils", photo: "images/waterpencils.jpg", beschreibung: "12 Colours,extremely good quality", price: 20, category: "painting" };
    let acryl = { name: "Mont Marte Acrylic Paints", photo: "images/paints12.jpg", beschreibung: "Set of 24 Colours x 36ml", price: 30, category: "painting" };
    let rowney = { name: "Daler Rowney Acrylic Paints", photo: "images/paint13.jpg", beschreibung: "Simply Acrylic Paint Bottle x75ml, Different Colours available", price: 5, category: "painting" };
    let artikelnDrawing = [watercolors, paints, pencils, acryl, rowney]; //Array
    let sketch = { name: "Sketchbook Hardcover,Spiral", photo: "images/sketchbook1.jpg", beschreibung: "8,5x11; 80 Pages", price: 10, category: "sketchbooks" };
    let sketchrowney = { name: "Sketchbook D.Rowney", photo: "images/Sketchbook2.jpg", beschreibung: "14x11; 80 pages", price: 15, category: "sketchbooks" };
    let spocket = { name: "Pocket Sketchbook R.Downey", photo: "images/Sketchbook3.jpg", beschreibung: "3,5x5,5; 144 Pages", price: 12, category: "sketchbooks" };
    let mixmedia = { name: "Sketchbook Mix Media", photo: "images/mixmedia.jpg", beschreibung: "7x10in; 60 Seiten", price: 20, category: "sketchbooks" };
